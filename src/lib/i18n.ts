...
export const T: Record<string, Record<Lang, string>> = {
  ...
  yrSecTitle14: { ko: '올해 분기별 에너지 리듬', en: 'Quarterly Energy Rhythm' },
  yrSecTitle15: { ko: '올해 나만의 행운 루틴', en: 'My Lucky Daily Routine' },
  yrSecTitle16: { ko: '올해 중요한 결정 타이밍 TOP 3', en: 'Top 3 Decision Timings' },
  yrSecTitle17: { ko: '올해 하반기 반전 포인트', en: 'Second Half Turning Point' },
  ...
  yrSecHint14: { ko: '1~4분기 에너지 수준과 집중 전략...', en: 'Quarterly energy levels and focus strategy...' },
  yrSecHint15: { ko: '매일 실천할 개운 습관 5가지...', en: 'Five daily fortune-boosting habits...' },
  yrSecHint16: { ko: '큰 결정 하기 좋은 달 TOP 3...', en: 'Top 3 months for major decisions...' },
  yrSecHint17: { ko: '하반기 반전과 2027년 연결 흐름...', en: 'Second half comeback and 2027 connection...' },
