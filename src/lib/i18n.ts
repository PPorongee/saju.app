...
export const T: Record<string, Record<Lang, string>> = {
  ...
  yearlyItems: { ko: '2026 운세 분석 항목 (17개)', en: '2026 Fortune Items (17)' },
  ...
  yrSecTitle3: { ko: '올해 분기별 에너지 리듬', en: 'Quarterly Energy Rhythm' },
  ...
  yrSecHint3: { ko: '분기별 에너지 수준과 집중 전략...', en: 'Quarterly energy levels and focus strategy...' },
  ...
  yrSecTitle8: { ko: '올해 재물운 & 투자 타이밍', en: 'Money & Investment Timing' },
  yrSecTitle9: { ko: '올해 연애운 & 인연 캘린더', en: 'Love & Romance Calendar' },
  yrSecTitle10: { ko: '올해 건강 주의보', en: 'Health Watch This Year' },
  yrSecTitle11: { ko: '올해 유리한 방위 & 여행지', en: 'Lucky Directions & Travel' },
  yrSecTitle12: { ko: '올해 직장 & 사업 전환점', en: 'Career & Business Turning Points' },
  yrSecTitle13: { ko: '올해 대인관계 & 귀인 캘린더', en: 'Relationships & Noble Helper Calendar' },
  yrSecTitle14: { ko: '올해 나만의 행운 루틴', en: 'My Lucky Daily Routine' },
  yrSecTitle15: { ko: '올해 중요한 결정 타이밍 TOP 3', en: 'Top 3 Decision Timings' },
  yrSecTitle16: { ko: '올해 하반기 반전 포인트', en: 'Second Half Turning Point' },
  yrSecTitle17: { ko: '2026 총평 & 마무리', en: '2026 Summary & Closing' },
  yrSecHint8: { ko: '재성 흐름으로 보는 돈의 타이밍...', en: 'Money flow timing from wealth stars...' },
  yrSecHint9: { ko: '인연이 들어오는 달, 연애 변화...', en: 'When love arrives, relationship changes...' },
  yrSecHint10: { ko: '오행 균형으로 보는 건강 관리...', en: 'Health management from elemental balance...' },
  yrSecHint11: { ko: '용신 기반 여행/이사 길한 방위...', en: 'Favorable directions for travel/moving...' },
  yrSecHint12: { ko: '승진/이직/사업 최적 타이밍...', en: 'Best timing for promotion/job change...' },
  yrSecHint13: { ko: '귀인 만나는 달, 관계 전략...', en: 'When to meet helpers, relationship strategy...' },
  yrSecHint14: { ko: '매일 실천할 개운 습관 5가지...', en: 'Five daily fortune-boosting habits...' },
  yrSecHint15: { ko: '큰 결정 하기 좋은 달 TOP 3...', en: 'Top 3 months for major decisions...' },
  yrSecHint16: { ko: '하반기 반전과 2027년 연결 흐름...', en: 'Second half comeback and 2027 connection...' },
  yrSecHint17: { ko: '올해 종합 총평과 2025/2027 비교...', en: 'Year summary with 2025/2027 comparison...' },
