...
export const T: Record<string, Record<Lang, string>> = {
  ...
  yearlyItems: { ko: '2026 운세 분석 항목 (10개)', en: '2026 Fortune Items (10)' },
  ...
  secTitle4: { ko: '연애 & 결혼 타이밍', en: 'Love & Marriage Timing' },
  secTitle5: { ko: '질문의 답으로 보는 너의 모습 분석', en: 'Your Portrait Through Your Answers' },
  ...
  secHint4: { ko: '배우자궁·인연 타이밍·결혼 시기...', en: 'Spouse palace, destiny timing & marriage...' },
  secHint5: { ko: '네 답변을 사주로 깊이 분석...', en: 'Deep analysis of your answers through Saju...' },
  ...
  yrSecTitle4: { ko: '올해 재물운 & 투자 타이밍', en: 'Money & Investment Timing' },
  yrSecTitle5: { ko: '올해 연애운 & 인연 캘린더', en: 'Love & Romance Calendar' },
  yrSecTitle6: { ko: '올해 직장/건강 종합', en: 'Career & Health Overview' },
  yrSecTitle7: { ko: '올해 대인관계 & 귀인 캘린더', en: 'Relationships & Noble Helpers' },
  yrSecTitle8: { ko: '조심할 것 & 결정 타이밍', en: 'Cautions & Decision Timing' },
  yrSecTitle9: { ko: '행운 아이템 & 개운 루틴', en: 'Lucky Items & Fortune Routine' },
  yrSecTitle10: { ko: '2026 총평 & 하반기 전략', en: '2026 Summary & Strategy' },
  yrSecHint1: { ko: '대운·세운·삼재 + 올해 핵심 미션...', en: 'Luck cycles + core mission for the year...' },
  ...
  yrSecHint4: { ko: '재성 흐름으로 보는 돈의 타이밍...', en: 'Money flow timing from wealth stars...' },
  yrSecHint5: { ko: '인연이 들어오는 달, 연애 변화...', en: 'When love arrives, relationship changes...' },
  yrSecHint6: { ko: '승진/이직 + 오행 건강 관리...', en: 'Career turning points + health management...' },
  yrSecHint7: { ko: '귀인 만나는 달, 관계 전략...', en: 'When to meet helpers, relationship strategy...' },
  yrSecHint8: { ko: '주의사항 TOP 3 + 큰 결정 좋은 달...', en: 'Top 3 cautions + best months for decisions...' },
  yrSecHint9: { ko: '행운 색/숫자/방위 + 개운 루틴...', en: 'Lucky colors/directions + daily routine...' },
  yrSecHint10: { ko: '하반기 전략 + 2025/2027 비교...', en: 'Second half strategy + year comparison...' },
