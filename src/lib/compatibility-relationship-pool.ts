 ...
 * 메인 1개(UI 카드) + 매콤 1~2개(본문 매콤 섹션용)를 자동 매칭한다.
 * 점수가 0이면 부적합으로 제외된다.
 */
...
export const RELATIONSHIP_POOL: Relationship[] = [
  ...
  // ============================================================
  {
    ...
    title: '벗어날 수 없는 자기장',
    emoji: '🧲',
    tagline: '천간·지지가 동시에 끌어당기는 사주적 운명',
  ...
  },
  {
    ...
    title: '0초 만에 통하는 듀오',
    emoji: '⚡',
    tagline: '처음 봤는데도 평생 알았던 것 같은 데자뷔',
    description: '일간 천간합 또는 일지 육합으로 묶여있어 처음 봐도 익숙하고 편안한 친밀감. 말 없이도 통하는 코드가 있고, 거리를 빠르게 좁히는 인연.',
    match: (ctx) => {
      let s = 0; const r: string[] = [];
  ...
  },
  {
    id: 'day-and-night',
    category: '보완형',
    title: '정반대로 완성되는 24시간',
    emoji: '🌗',
    tagline: '낮과 밤처럼 합쳐야 하루가 완성되는',
  ...
  // ============================================================
  {
    ...
    title: '늘 챙기는 케어 모드',
    emoji: '🥺',
    tagline: '한쪽이 무조건 챙기고 한쪽이 받아 자라는',
  ...
  },
  {
    id: 'mentor-student',
    category: '역할형',
    title: '가르치고 배우는 사제 케미',
    emoji: '📚',
    tagline: '한쪽이 깨우치고 한쪽이 따라 성장하는',
  ...
  },
  {
    ...
    title: '든든한 방패 + 그늘 모드',
    emoji: '🛡️',
    tagline: '한쪽이 든든히 지키고 한쪽이 그 그늘에서 쉬는',
  ...
  },
  {
    ...
    title: '전략가 X 실행가 듀오',
    emoji: '🎯',
    tagline: '한쪽이 방향 잡고 한쪽이 실행해 결과 내는',
  ...
  },
  {
    id: 'farmer-land',
    category: '역할형',
    title: '정성 들이면 결실 나오는 사이',
    emoji: '🌾',
    tagline: '가꾼 만큼 보답이 돌아오는 누적형 인연',
  ...
  },
  {
    id: 'gym-buddy',
    category: '도전형',
    title: '같이 단단해지는 운동 메이트',
    emoji: '🏋️',
    tagline: '같은 목표 향해 동반 성장하는',
  ...
  // ============================================================
  {
    ...
    title: '못 내리는 롤코',
    emoji: '🎢',
    tagline: '올라갈 땐 짜릿, 내려갈 땐 비명, 그래도 못 끊는',
  ...
  },
  {
    ...
    title: '라면 + 김치급 단짝',
    emoji: '🍜',
    tagline: '따로는 평범한데 같이는 멈출 수 없는 조합',
  ...
  },
  {
    id: 'foggy-road',
    category: '주의형',
    title: '어디로 가는지 모를 안개 케미',
    emoji: '🌫️',
    tagline: '미운 정 + 애증 패턴이 반복되는',
  ...
  },
  {
    id: 'timebomb',
    category: '주의형',
    title: '한 번 터지면 큰 시한폭탄',
    emoji: '💣',
    tagline: '평소엔 멀쩡, 결정적 순간 폭발',
 ...
 * 점수 0인 항목은 제외.
 */
export function selectMainRelationships(ctx: CompatContext, n: number = 1): RelationshipMatch[] {
