...
export function buildSajuPrompts(sj: SajuResult, ohCount: Record<string, number>, userData: UserData): string[] {
  ...
  prompt += '[중요: 올해(2026) 월별 운세, 올해 전체 운세 분석은 "올해 운세" 별도 메뉴에서 제공함. 개인사주에서는 올해 운세를 상세히 다루지 마! 대운/세운 흐름에서 올해를 간략히 언급하는 정도만 OK.]\n';
  ...
  prompt2 += '##11.향후 10년 미래 시나리오 (2026~2036)## [주의: 올해(2026) 월별 상세 운세는 "올해 운세" 별도 메뉴에서 제공하므로 여기서는 다루지 마. 2026년은 한줄 요약만, 2027년부터 상세히.] 향후 10년간의 전체적인 흐름을 연도별로 분석해줘:\n' +
